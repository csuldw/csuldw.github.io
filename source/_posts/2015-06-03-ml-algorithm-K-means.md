...
Github源码:[https://github.com/csuldw/MachineLearning/tree/master/Kmeans](https://github.com/csuldw/MachineLearning/tree/master/Kmeans)
...
设计的目的：<font color="#1986C7">**使各个样本与所在簇的质心的均值的误差平方和达到最小**</font>（这也是评价K-means算法最后聚类效果的评价标准）。
